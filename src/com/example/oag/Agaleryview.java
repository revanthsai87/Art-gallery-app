...
public class Agaleryview extends Activity {
	ImageView out;
	TextView aaa;
	SQLiteDatabase db;
	ListView l;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_agaleryview);
		...
		final ArrayList<String> list = new ArrayList<String>();
		 ...
		 Cursor res=db.rawQuery("SELECT * FROM art", null);
		if(res.getCount()!=0)
		{
			while (res.moveToNext())
			{
	            list.add("Art Title:   "+res.getString(0)+"\nName:   "+res.getString(1)+"\n"+"Description:   "+res.getString(2)+"\n"+"Date:   "+res.getString(3));
		...
		t1.addTextChangedListener(new TextWatcher(){
			...
			public void onTextChanged(CharSequence s, int start, int before,
					int count) {
				// TODO Auto-generated method stub
				 Agaleryview.this.adapter.getFilter().filter(s); 
		...
		l.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				 ...
				 // two buttons (start)
				  // TODO Auto-generated method stub
				AlertDialog.Builder alertDialog = new AlertDialog.Builder(Agaleryview.this);
		        ...
		        alertDialog.setPositiveButton("YES", new DialogInterface.OnClickListener() {
		            ...
		            // Write your code here to invoke YES event
		            	Cursor c=db.rawQuery("SELECT * FROM art", null);
		        		if(c.moveToFirst())
		        		{
		        			db.execSQL("DELETE FROM art WHERE uid='"+c.getString(0)+"'");
		        			 Toast.makeText(getApplicationContext(), "User Deleted Successfully", Toast.LENGTH_SHORT).show();
		        			 Intent a=new Intent(getApplicationContext(),Agaleryview.class);
		        			 return;
		        		}	
		            }
		        });
		        ...
		        alertDialog.setNegativeButton("NO", new DialogInterface.OnClickListener() {
		            ...
		            Intent b=new Intent(getApplicationContext(),Agaleryview.class);
		            startActivity(b);
